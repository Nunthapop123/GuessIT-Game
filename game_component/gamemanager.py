...
import sys
import random
from game_component.constants import SCREEN, WIDTH, HEIGHT, BOMB_ICON, MAGNIFY_ICON, LETTER_FONT, LETTER_X_SPACING, LETTER_Y_SPACING, \
    BACKGROUND, BACKGROUND_RECT
from game_component.words import Word
from game_component.words_data import WORDS
from game_component.player import Player
from game_component.letters import Letter
from game_component.items import Bomb, Magnifying_Glass
from game_component.stats import GameStats
from game_component.shops import Shop
import subprocess
                    ...
                    if event.button == 1:
                        if self.game_state == "menu":
                            if self.play_button_rect.collidepoint(event.pos):
                                ...
                                subprocess.Popen(["python", "game_component/visualize.py"])
